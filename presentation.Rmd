...
Users trust in our quality - code of practice

We need to have quality processes
...
2. Files are produced using reproducible and auditable code, with no manual steps
...
Our best pratice is similar to their minimum expectations, so we have work to do!
...
Again, I'll come back to this shortly, though before I go into the self-assessment app and guidance I'll quickly recap
...
https://cjrace.github.io/20201217-introduction-to-rap/index.html
...
Slides are available at that link, using GitHub pages
